    ...
    <el-form class="form-container" :model="postForm" :rules="rules" ref="postForm" label-width="65px">
      ...
      <div class="createPost-main-container">
        ...
        <el-form-item style="margin-bottom: 40px;" label="封面图:" prop="image_uri">
          <Upload :fileList="postForm.image_uri" @fileChange="imgChange"></Upload>
        </el-form-item>

        <el-form-item style="margin-bottom: 40px;" label="产品图:" prop="pic_uri">
          <Upload :fileList="postForm.pic_uri" @fileChange="picChange"></Upload>
        </el-form-item>
...
export default {
  ...
  methods: {
    // 封面图的值改变时
    imgChange(val) {
      this.postForm.image_uri = val
    },
    // 产品图的值改变时
    picChange(val) {
      this.postForm.pic_uri = val
    },
    // 编辑状态时，获取数据
    fetchData(query) {
